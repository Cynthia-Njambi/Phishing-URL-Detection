...
### DATA
The dataset we have is from Mendely which is stored in a folder on Google Drive known as Phishing Website Detection Dataset, The data contained the URL and its labelled and from the URL other features were extracted
### PROJECT GOAL
